...
disp(' ')
disp('--- (4.63) éÆÇñûë´Ç≥ÇπÇÈÇÊÇ§Ç» K ---------')
...
disp(' ')
disp('--- á@ d11 = 4, d10 = 4, d21 = 8, d20 = 16 Ç∆ÇµÇΩÇ∆Ç´ÇÃ K = K1 ---------')
K1 = subs(K,{d11,d10,d21,d20},{4,4,8,16})

disp(' ')
disp('--- A + B*K1 ÇÃå≈óLíl ---------')
Acl1 = A + B*K1;
eig(Acl1)
...
disp('_______________________________________________________________________')
disp(' ')
disp('--- áA d11 = 8, d10 = 16, d21 = 4, d20 = 4 Ç∆ÇµÇΩÇ∆Ç´ÇÃ K = K2 ---------')
K2 = subs(K,{d11,d10,d21,d20},{8,16,4,4})

disp(' ')
disp('--- A + B*K2 ÇÃå≈óLíl ---------')
Acl2 = A + B*K2;
eig(Acl2)
...
disp('_______________________________________________________________________')
disp(' ')
disp('--- áB d11 = 6, d10 = 8, d21 = 6, d20 = 8 Ç∆ÇµÇΩÇ∆Ç´ÇÃ K = K3 ---------')
K3 = subs(K,{d11,d10,d21,d20},{6,8,6,8})

disp(' ')
disp('--- A + B*K3 ÇÃå≈óLíl ---------')
Acl3 = A + B*K3;
eig(Acl3)
...
disp('_______________________________________________________________________')
disp(' ')
disp('--- x(t) = exp(A*t)*x0 (u(t) = 0ÅFêßå‰Ç»Çµ) ---------')
